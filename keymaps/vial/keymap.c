...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT( //Numpad and Punctuation
		...
		KC_LCTL, KC_1, KC_2, KC_3, KC_PENT, KC_ASTR,                                KC_BSLS, KC_AT, KC_CIRC, KC_LPRN, KC_RPRN, KC_UNDS,  
		XXXXXXX, XXXXXXX, XXXXXXX, LGUI_T(KC_BSPC), TO(0), LSFT_T(KC_SLSH),         KC_PENT, LGUI(KC_SPC), KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX), 
	...
	[2] = LAYOUT( //Punctuation and Arrow key
		...
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPLY, KC_MUTE,   
